...
<body>
	...
	<div class="container-fluid " style="background-color: #D6EAF8;">
		<div class="row">
			<a href="#" class="text-decoration-none p-2 text-primary">Event Management
				></a>
		</div>
	</div>
			...
			<div class="col-6 col-md-3 p-2 ">
				<div class="card shadow-sm p-3 mb-5 bg-white rounded"
					...
					<a href="Home"
						...
						href="Candidate"
						class="btn btn-outline-light border-bottom text-left text-dark"><i
						class="fas fa-user-friends"></i> Candidate Management</a> <a href="Event"
			...
			<div class="col-12 col-md-9 p-2" style="height: 650px;">
				...
				<div class="card shadow-sm p-3 bg-white">
				 	...
				 	<table class="table table-hover table-striped">
								...
								<c:forEach var="Event" items="${eventDetail}" varStatus="status">
									<tr>
										<td>${Event.site }</td>
										<td>${Event.course_Code }</td>
										<td>${Event.course_Name }</td>
										<td>${Event.subject_Type }</td>
										<td>${Event.sub_Subject_Type }</td>
										<td>${Event.format_Type }</td>
										<%-- <td><a href="UpdateEvent?id=${Event.event_id }">View</a></td> --%>
										<td><button type="button" class="btn btn-success" onclick="location.href='viewEvent?id=${Event.event_id }'">View</button></td>
									</tr>
								</c:forEach>
