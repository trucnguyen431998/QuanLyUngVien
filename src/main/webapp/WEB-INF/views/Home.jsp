...
<body>
	...
	<div class="container-fluid" style="background-color: #D6EAF8;">
		<div class="row">
			<a href="#" class="text-decoration-none p-2 text-primary">Home ></a>
		</div>
	</div>
	<main>
	<div class="container-fluid bg-light mb-12">
		<div class="row">
			<div class="col-6 col-md-3 p-2 ">
				<div class="card shadow-sm p-3 mb-5 bg-white rounded"
					...
					<a href="Home"
						...
						style="background-color: #A6ACAF;"><i class="fas fa-home"
						style="font-size: 20px;"></i> 
						Home</a> 
						<a href="Candidate"
						class="btn btn-outline-light border-bottom text-left text-dark"><i
						class="fas fa-user-friends"></i> Candidate Management</a> 
						<a href="Event"
						class="btn btn-outline-light border-bottom text-left text-dark"><i
			...
			<div class="col-12 col-md-6 bg-white p-2" style="height: 650px;">
						...
						<table class="table table-hover table-striped">
								...
								<c:forEach var="Event" items="${enven}" varStatus="status">
									<tr>
										<td>${Event.site }</td>
